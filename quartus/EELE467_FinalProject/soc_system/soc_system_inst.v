	soc_system u0 (
		...
		.export_red_out                  (<connected-to-export_red_out>),                  // export.red_out
		.export_green_out                (<connected-to-export_green_out>),                //       .green_out
		.export_blue_out                 (<connected-to-export_blue_out>)                  //       .blue_out
	);
